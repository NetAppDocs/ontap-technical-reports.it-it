...
NOTE: L'API REST /api/storage/volumes viene utilizzata per scopi che vanno oltre il semplice accesso ai file. Viene utilizzata da System Manager e da altre interfacce GUI per creare, visualizzare e modificare volumi.
