...
NOTE: NetApp ONTAP soddisfa il requisito per l'accesso web https://www.netapp.com/pdf.html?item=/media/17055-tr4647.pdf["Autenticazione a più fattori (MFA)"^] in System Manager e per l'autenticazione SSH CLI.
