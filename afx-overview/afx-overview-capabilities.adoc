...
Per ulteriori informazioni su come i volumi FlexGroup traggono vantaggio dall'architettura AFX, vedere link:afx-overview-architecture.html#flexgroup-volume-management-improvements["Miglioramenti nella gestione dei volumi FlexGroup"].
